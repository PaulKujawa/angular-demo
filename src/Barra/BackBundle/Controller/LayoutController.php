...
class LayoutController extends Controller
{
    public function navAction($request)
    {
        $entries = array(
            ...
            3 => array('path'=>'barra_back_measurements',   'label' => 'measurements'),
            4 => array('path'=>'barra_back_ingredients',    'label' => 'ingredients'),
            5 => array('path'=>'barra_back_manufacturers',  'label' => 'manufacturers'),
        );

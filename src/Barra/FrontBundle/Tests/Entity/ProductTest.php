...
{
    const SELF_FQDN          = 'Barra\FrontBundle\Entity\Product';
    const INGREDIENT_FQDN    = 'Barra\FrontBundle\Entity\Ingredient';
    const MANUFACTURER_FQDN  = 'Barra\FrontBundle\Entity\Manufacturer';
    const ID                 = 2;
    ...
    {
        $ingredientMock = $this->getMock(self::INGREDIENT_FQDN);
    ...
    public function getRecipes()
    {
        ...
        ;
        $this->model->addIngredient($ingredientMock);
    ...
    {
        $recipeMock = $this->getMock(self::MANUFACTURER_FQDN);
        $resource   = $this->model->setManufacturer($recipeMock);
        $this->assertInstanceOf(
            self::SELF_FQDN,
            $resource
        );

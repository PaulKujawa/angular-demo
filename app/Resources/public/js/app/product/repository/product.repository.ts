...
export class ProductRepository {
    ...
    public getProducts(filter: HttpParams): Observable<Pageable<Product>> {
        ...
        return this.http.get<Pageable<ProductResponseDto>>(url, {params: filter})
    ...
    public postProduct(productLike: Product): Observable<Product> {
        ...
        return this.http.post<ProductResponseDto>(url, {product: productDto})
            .map((dto) => new Product(dto))
            .do(() => this.apiEventHandler.postSuccessMessage('app.api.post_success'))
            .catch((error) => this.apiEventHandler.catchError(error));
    }
    ...
    public putProduct(product: Product): Observable<void> {
        ...
        return this.http.put<void>(url, {product: productDto})
            .do(() => this.apiEventHandler.postSuccessMessage('app.api.update_success'))
            .catch((error) => this.apiEventHandler.catchError(error));
    }
    ...
    public deleteProduct(id: number): Observable<void> {
        ...
        return this.http.delete<void>(url)
            .do(() => this.apiEventHandler.postSuccessMessage('app.api.delete_success'))
            .catch((error) => this.apiEventHandler.catchError(error));
    }
}
